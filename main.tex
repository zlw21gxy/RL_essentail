...
\paragraph{Greedy}\label{header-n16852}}
...
\paragraph{Policy-gradient off-policy}\label{header-n16886}}
...
\subsubsection{basic idea}\label{header-n291}}
为方便参考，给出熵与KL的计算公式如下：
\begin{align}
...
\subsubsection{Continuous action spaces}\label{header-n304}}

\hypertarget{header-n305}{%
\paragraph{Policy Function}\label{header-n305}}
\begin{equation}
...
\paragraph{Value Function}\label{header-n308}}
\begin{equation}
...
\subsubsection{Discrete action spaces}\label{header-n315}}
\begin{equation}
